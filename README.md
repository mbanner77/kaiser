...
## Version 3.10 — Redselige Bots, Heimkehr im Hafen, wählbare Spielstärke

- **Bots reagieren auf Euer Handeln:** Wer einem Computer-Regenten den Krieg erklärt, bekommt eine Antwort nach Charakter — der Eroberer höhnt, der Händler rechnet vor, der Baumeister vertraut seinen Mauern. Nach jeder Schlacht mit menschlicher Beteiligung kommentiert der Bot den Ausgang in der Ergebniskarte; gefasste Spione, verweigerter Bündnis-Beistand, gezahlte oder abgelehnte Tribute lösen ebenfalls passende Worte aus.
- **Die Heimkehr der Expedition** ist nun eine eigene Hafenszene: Das Schiff läuft bei tiefer Abendsonne ein, rafft die Segel, die Menge am Kai jubelt und winkt, Böller-Salut und Schatz-Funkeln inklusive — je nach Ausgang mit Goldtruhe, Warenkisten oder Seekarten an Deck. Bleibt die Expedition verschollen, wartet die Menge im Regen vergebens an der flackernden Hafenlaterne, nur Treibholz findet zurück.
- **Wählbare Bot-Stärke je Reich** im Setup: 🐢 Behäbig, ⚖️ Ausgewogen, 🦊 Gerissen, 🔥 Gnadenlos. Gerissene und gnadenlose Bots stellen planvoll auf, halten Verteidigungs-Reserven (bis 25 %), mischen Reiterei und Geschütze ins Heer, stellen Gegenspione, mauern höher, wagen Belagerungs-Ausfälle früher und wirtschaften besser. Der Gnadenlose führt spürbar öfter Krieg — auch gegen Reiche, mit denen er leidlich auskommt — und begnügt sich mit knapperem Kräftevorteil; der Behäbige rüstet schwächer und lässt die Heere fast immer daheim. Die Stufe steht im Weltkarten-Dossier und bleibt im Spielstand erhalten.

## Version 3.11 — Kompanien, Intrigen, Dynastie, Katastrophen und Komfort

- **Freie Söldner-Kompanien:** Sechs benannte Banden („Die Eisernen Reiter", „Die Schwarze Schar" …) lagern wechselnd vor den Toren — sofort schlagkräftig gegen Handgeld und Jahressold. Siege mehren ihren Ruf (und Preis). Wer den Sold schuldig bleibt, erlebt die Meuterei: Die Kompanie plündert die Speicher und tritt womöglich in die Dienste des ärgsten Feindes. Gerissene Bots heuern selbst an.
- **Erweiterte Dynastie:** Dem Thronfolger können Geschwister geboren werden (bis drei Kinder). Kinder ab 15 lassen sich am Heiratsmarkt an fremde Höfe vermählen — Brautgeld, +18 Verhältnis, 12 Jahre Frieden. Stirbt der Regent mit unmündigem Erben, übernimmt ein Regentschaftsrat (−12 % Steuern, Veruntreuungs-Gefahr), bis der junge Regent mit 16 mündig wird.
- **Hofintrigen:** Neue Schattenkarte in der Diplomatie — Günstling kaufen (Geheimbericht, 6 Jahre leichtere Intrigen), Skandal streuen (Stimmung und Ansehen des Ziels sinken) und das Attentat gegen erklärte Feinde: Gelingt es unerkannt, stürzt der Regent „an verdorbenem Wein"; fliegt es auf, ächtet Euch ganz Europa und die Blutrache droht. Gegenspione erschweren alles, gerissene Bots intrigieren selbst.
- **Katastrophen-Jahre:** Selten warnen alle Hofastrologen einmütig — ein Jahr später schlägt Vulkanwinter (Ernte −60 %, volle Speicher mildern), Jahrhundertflut (40 🪨 Stein für Notdämme retten Mühlen und Korn) oder der Große Komet (Panik bei schlechter Stimmung) zu. Wer die Warnung nutzt, kommt glimpflich davon.
- **Chronik-Buch:** Nach Sieg oder Schlusswertung schlägt ein ledergebundenes Buch die Partie auf: Titelblatt mit Siegerporträt, Machtindex-Verlauf aller Häuser, Rekorde der Epoche, denkwürdige Begebenheiten und Schlussblatt mit Wachssiegel — jedes Blatt als Bild speicherbar, mit Umblätter-Animation.
- **Einstellungen:** Eigener ⚙️-Bildschirm mit Musik-/Effekt-Reglern, wählbarem Szenen-Tempo (ausführlich · gerafft · nur Ergebnis) und Farbenblind-Modus (Okabe-Ito-Palette, wirkt sofort auch in laufenden Partien).
- **Komfort:** ↩️ Rückgängig für die letzte Handelsaktion, ¼/½/Max-Schnellwahl beim Handeln, Tastaturkürzel am Rechner (B Bauen · D Diplomatie · W Weltkarte · S Statistik · ? Hilfe).
- **Online-Mehrspieler:** Nach einem Verbindungsabriss verbindet sich das Spiel selbst neu und steigt still wieder in die laufende Partie ein (bis zu 6 Versuche). Die Feldpost hat Schnellnachrichten-Knöpfe (👍 😄 ⚔️ 🕊️ 🐢 🏆).

## Version 3.12 — Seehandel, Geschichten, Stadt-Panorama, Feilschen und Klangkulisse

- **Piraten, Kaperbriefe & Seehandel:** Besitzen beide Handelspartner einen Hafen, wird ihre Route zur Seeroute mit 60 % mehr Zoll — aber Piraten lauern: Ohne Geleitschutz kapern Freibeuter die Koggen, jedes Kriegsschiff senkt die Gefahr. Mit dem Kaperbrief (Diplomatie) schickt Ihr selbst Freibeuter unter falscher Flagge auf fremde Kauffahrer — fette Beute, wenn niemand Euren Namen erfährt; Skandal und Kriegsgefahr, wenn doch. Aggressive und gerissene Bots kapern ebenfalls.
- **Mehrjährige Ereignis-Ketten:** Drei Geschichten in je drei Teilen — „Der Fremde mit dem Siegelring", „Die Falschmünzer" und „Das Wunder von der Dorfkirche". Jede Entscheidung öffnet Jahre später die Fortsetzung, mit unterschiedlichen Enden: vom heimgekehrten Erben über stille Prägewerkstätten bis zum Küster mit der Ölkanne. Jede Geschichte wird nur einmal erzählt.
